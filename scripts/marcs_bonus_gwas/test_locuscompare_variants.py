...
def main():
    ...
    subprocess.call("rm -rf /users/mgloud/projects/brain_gwas/output/ipsc-rerun-locuscompare-tests/*", shell=True)

    kept_data = []
    with open("/users/mgloud/projects/ipsc/output/snps_to_test_locuscompare_fdr05_window10000.txt") as f:
        all_data = []
        f.readline()
        for line in f:
...
template = '''
{
        "out_dir_group": "ipsc-rerun-locuscompare-tests",
